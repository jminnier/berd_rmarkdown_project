---
title: 'Example: Files in subfolder from main .Rproj folder'
...
fs::dir_create(here::here("report3-output-here"))
# save as csv file
write_csv(nhanes_kids, path=here::here("report3-output-here","nhanes_kids_here.csv"))
```
